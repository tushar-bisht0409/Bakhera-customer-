...
import 'package:Service/screens/vendorscreen.dart';
...
class _AllVendorsScreenState extends State<AllVendorsScreen> {
  ...
  void initState() {
    super.initState();
    strm = FirebaseFirestore.instance.collection('vendors').snapshots();
  }
                                                  ...
                                                  Column(children: <Widget>[
                                                    ...
                                                    Container(
                                                        width: ScreenUtil()
                                                            .setWidth(150),
                                                        child: Text(
                                                            '${dataDocs[index].data()['vendor_city']}',
                                                            style: GoogleFonts.lato(
                                                                fontSize:
                                                                    ScreenUtil()
                                                                        .setSp(
                                                    ...
                                                    Container(
                                                      ...
                                                      //                .centerRight,
                                                      child: Text(
                                                          'Open  :  ${dataDocs[index].data()['working_days']} ',
                                                          style: GoogleFonts.lato(
                                                              fontSize:
                                                                  ScreenUtil()
                                                                      .setSp(
